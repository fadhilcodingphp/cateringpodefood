    ...
    <div class="container">
      <div class="row">
        <div class="col-6 mb-6">
          <h3 class=" mb-4">
            Produk Paket Catering <span class="text-primary">Pode Food</span>
          </h3>
        </div>
        <div class="col-5">
      ...
      <div class="row g-4 row-cols-lg-5 row-cols-2 row-cols-md-3">
        ...
        if (isset($_POST["cari"])) {
          ...
          $ambil = mysqli_query($conn, "SELECT * FROM produk WHERE produk.ID_Kategori = 'KPC004'");
        }
        ?>
        <?php while ($pecah = mysqli_fetch_assoc($ambil)) { ?>
          ...
          <div class="col">
            <div class="card card-product">
              <div class="card-body ">
                <div class="text-center position-relative mb-2" style="width:100%; height:200px;"> <a href="MenuDetailPaket.php?id=<?= $pecah['ID_Produk']; ?>">
                ...
                <h3 class="fs-5">
                  <a href="MenuDetailPaket.php?id=<?= $pecah['ID_Produk']; ?>" class="text-inherit text-primary text-decoration-none"><?php echo $pecah['Nama_Produk']; ?></a>
                </h3>
