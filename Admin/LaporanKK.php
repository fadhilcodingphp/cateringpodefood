                     ...
                     <table class="table datatable">
                        ...
                        <tbody>
                           <?php $ambil = mysqli_query($conn, "SELECT * FROM pesanan
                             ...
                             INNER JOIN pelanggan ON pesanan.ID_Pelanggan = pelanggan.ID_Pelanggan $sqlPeriode WHERE pesanan.Jenis_Acara='Konsumsi Karyawan' $sqlPeriode ORDER BY pesanan.Tgl_Pesan ASC") ?>
