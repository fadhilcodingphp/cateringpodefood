      ...
      <div class="pagetitle">
         ...
         <nav>
            <ol class="breadcrumb">
               ...
               <li class="breadcrumb-item active">Catering Acara Kantoran</li>
            </ol>
         </nav>
      </div>
      <?php $i = 1; ?>
      <section class="section">
         <div class="row">
            <div class="col-lg-12">
               <div class="card">
                  <div class="card-body">
                     <h5 class="card-title">Laporan Pesanan Catering Acara Kantoran Periode tanggal <b><?= ($tglAwal); ?></b> s/d <b><?= ($tglAkhir); ?></b></h5>
                     ...
                     <a class="btn btn-primary mt-2" href="LaporanAKExcel.php?sqlPeriode=<?= $sqlPeriode; ?>" target="_blank" alt="Edit Data"> <i class="ri-download-2-fill"></i> Download Excel</a>
                     <table class="table datatable">
                        ...
                        <tbody>
                           <?php $ambil = mysqli_query($conn, "SELECT * FROM pesanan
                             ...
                             INNER JOIN pelanggan ON pesanan.ID_Pelanggan = pelanggan.ID_Pelanggan WHERE pesanan.Jenis_Acara='Acara Kantoran' $sqlPeriode ORDER BY pesanan.Tgl_Pesan ASC") ?>
