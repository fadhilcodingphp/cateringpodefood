      ...
      <div class="pagetitle">
         ...
         <nav>
            <ol class="breadcrumb">
               ...
               <li class="breadcrumb-item active">Catering Acara Lainnya</li>
            </ol>
         </nav>
      </div>
      <?php $i = 1; ?>
      <section class="section">
         <div class="row">
            <div class="col-lg-12">
               <div class="card">
                  <div class="card-body">
                     <h5 class="card-title">Laporan Pesanan Catering Acara Lainnya Periode tanggal <b><?= ($tglAwal); ?></b> s/d <b><?= ($tglAkhir); ?></b></h5>
                     ...
                     <a class="btn btn-primary mt-2" href="LaporanLainnyaExcel.php?sqlPeriode=<?= $sqlPeriode; ?>" target="_blank" alt="Edit Data"> <i class="ri-download-2-fill"></i> Download Excel</a>
