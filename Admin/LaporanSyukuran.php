      ...
      <div class="pagetitle">
         ...
         <nav>
            <ol class="breadcrumb">
               ...
               <li class="breadcrumb-item active">Syukuran</li>
            </ol>
         </nav>
      </div>
      <?php $i = 1; ?>
      <section class="section">
         <div class="row">
            <div class="col-lg-12">
               <div class="card">
                  <div class="card-body">
                     <h5 class="card-title">Laporan Syukuran</h5>
                     ...
                     <table class="table datatable">
                        ...
                        <tbody>
                           <?php $ambil = mysqli_query($conn, "SELECT * FROM pesanan
                             ...
                             INNER JOIN pelanggan ON pesanan.ID_Pelanggan = pelanggan.ID_Pelanggan WHERE pesanan.Jenis_Acara='Syukuran'") ?>
