...
<main id="main" class="main">
   ...
   <h5 class="card-title" style="text-align: center;">Laporan Penjualan Catering Acara Ulang Tahun</h5>
   <table>
      <?php $i = 1; ?>
      <thead>
         <tr>
      ...
      <tbody>
         <?php $ambil = mysqli_query($conn, "SELECT * FROM pesanan
                             ...
                             INNER JOIN pelanggan ON pesanan.ID_Pelanggan = pelanggan.ID_Pelanggan $sqlPeriode WHERE Jenis_Acara = 'Ulang Tahun' ORDER BY pesanan.Tgl_Pesan ASC
                             ") ?>
