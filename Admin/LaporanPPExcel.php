...
<main id="main" class="main">
   ...
   <h5 class="card-title" style="text-align: center;">Laporan Penjualan Catering Pesta Pernikahan</h5>
   <table>
      <?php $i = 1; ?>
      <thead>
         <tr>
      ...
      <tbody>
         <?php $ambil = mysqli_query($conn, "SELECT * FROM pesanan
                             ...
                             INNER JOIN pelanggan ON pesanan.ID_Pelanggan = pelanggan.ID_Pelanggan  $sqlPeriode WHERE Jenis_Acara = 'Pesta Pernikahan' ORDER BY pesanan.Tgl_Pesan ASC
                             ") ?>
         <?php while ($pecah = mysqli_fetch_assoc($ambil)) { ?>
            ...
            <?php $i++; ?>
         <?php } ?>
         <?php $total_Penjualan = mysqli_fetch_assoc(mysqli_query($conn, "SELECT SUM(Total_pesanan) AS total FROM pesanan WHERE Jenis_Acara = 'Pesta Pernikahan' $sqlPeriode"))["total"]; ?>
         <tr>
            <td></td>
